...
promedio de calificaciones de cada uno de ellos y, ademas, los alumnos con el
mejor promedio.

I,MAT,MAMAT y MEMAT:variables de tipo entero
CAL,SUM,MEPRO y PRO: variables de tipo real; */

void main (void)
{
    int I,MAT,MAMAT,MEMAT;
    float SUM,PRO,CAL,MAPRO = 0.0, MEPRO = 11.0;
    printf("Ingrese la matricula delprimer alumno:\t");
    scanf("%d",&MAT);
    while (MAT)
    {
        SUM = 0;
        ...
        printf("\n\nIngrese la matricula delsiguente alumno:");
        scanf("%d", &MAT);
    }
