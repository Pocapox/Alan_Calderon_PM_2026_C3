...
/* Empresa textil.
El programa, al recibir como datos decicivos la categoria y antiguedad de un
empleado, determinasi el mismo reune las condiciones establecidad por
...
{
    int CLA,CAT,ANT,RES;
    printf("\nIngrese la clave, categoria y antiguedad del trabajdor:");
